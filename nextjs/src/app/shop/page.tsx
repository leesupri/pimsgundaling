...
export default function ShopPage() {
  ...
  const col1 = { heading: t.shop.col1Title, items: t.shop.col1Items };
  const col2 = { heading: t.shop.col2Title, items: t.shop.col2Items };
    ...
    <>
      ...
      <main className="min-h-screen bg-earth-200 flex items-center justify-center px-6 py-32">
        <div className="max-w-lg w-full text-center">
          ...
          >
            <Image src="/images/mascot/cow_mascot_apron.svg" alt="Gundaling Mascot" width={160} height={160} className="mx-auto mb-8 select-none" draggable={false} />
          </motion.div>
          <AnimatedSection className="bg-white rounded-3xl shadow-2xl p-8 lg:p-10">
            ...
            <h1 className="font-display font-black text-earth-900 text-3xl lg:text-4xl mb-4 whitespace-pre-line">
              {t.shop.title}
            </h1>
            <p className="text-earth-600 text-base leading-relaxed mb-8">{t.shop.desc}</p>
            <div className="grid grid-cols-2 gap-3 mb-8 text-left">
              {[col1, col2].map(({ heading, items }) => (
                <div key={heading} className="bg-earth-50 rounded-xl p-3">
                  <p className="text-earth-500 text-xs font-bold uppercase tracking-wide mb-1">{heading}</p>
            ...
            <p className="text-earth-500 text-sm mb-5">{t.shop.interim}</p>
            <div className="flex flex-col gap-3">
              <motion.a
                href="https://wa.me/6282162599980?text=Halo%2C%20saya%20ingin%20memesan%20produk%20Gundaling%20Farmstead"
