...
const featureImages = [
  "/images/menu/cheese/Gundaling farmstead new menu-278-Edit.png",
  "/images/menu/pizza/Gundaling farmstead-117-Edit.png",
  "/images/menu/desserts/Gundaling farmstead-268.png",
  "/images/menu/karo/iga-bakar-karo.png",
];
...
function Hero() {
  ...
  return (
    <section ref={ref} className="relative h-screen min-h-[640px] overflow-hidden flex items-center">
      ...
      >
        <span className="text-white/50 text-xs uppercase tracking-widest">{t.home.heroScroll}</span>
        <motion.div
          animate={{ y: [0, 8, 0] }}
...
function Stats() {
  ...
  const stats = [
    { value: "20+", label: t.home.statsYears },
    { value: "50+", label: t.home.statsMenu },
    { value: "5",   label: t.home.statsCheese },
    { value: "13",  label: t.home.statsGelato },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <AnimatedSection direction="left">
            <span className="text-farm-400 text-xs uppercase tracking-[0.25em] font-bold mb-4 flex items-center gap-2">
              <span className="w-8 h-px bg-farm-400" />{t.home.storyLabel}
            </span>
            <h2 className="font-display font-black text-white text-4xl lg:text-6xl leading-tight mb-6">
              {t.home.storyTitle1}<br />
              <span className="text-farm-300 italic">{t.home.storyTitle2}</span><br />
              {t.home.storyTitle3}
            </h2>
            <p className="text-farm-200 text-base leading-relaxed mb-6">{t.home.storyP1}</p>
            <p className="text-farm-300 text-base leading-relaxed mb-8">{t.home.storyP2}</p>
            <Link
              href="/about"
            ...
            <div className="relative">
              ...
              >
                <Image
                  ...
                  alt="Holstein cattle at Gundaling Farmstead"
                  fill
    ...
    <section className="py-24 lg:py-32 bg-earth-200">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <AnimatedSection className="text-center mb-16">
          <span className="text-farm-500 text-xs uppercase tracking-[0.25em] font-bold mb-3 block">{t.home.featuresLabel}</span>
          <h2 className="font-display font-black text-earth-900 text-4xl lg:text-6xl">
            {t.home.featuresTitle1}<br />
            <span className="text-farm-600 italic">{t.home.featuresTitle2}</span>
          </h2>
        </AnimatedSection>

        <StaggerContainer className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {t.home.featuresData.map(({ title, description }, idx) => (
            <motion.div
              key={title}
              ...
              className="group"
            >
              <Link href={featureHrefs[idx]} className="block bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-shadow duration-400">
                ...
                <div className="p-5">
                  ...
                  <div className="flex items-center gap-1 mt-4 text-farm-500 text-sm font-bold group-hover:gap-2 transition-all">
                    {t.home.featureViewMenu} <span>→</span>
                  </div>
                </div>
              </Link>
            </motion.div>
  ...
  return (
    <section ref={ref} className="relative py-32 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-12 text-center">
        <AnimatedSection>
          <span className="text-farm-300 text-xs uppercase tracking-[0.25em] font-bold mb-4 block">{t.home.farmCtaLabel}</span>
          <h2 className="font-display font-black text-white text-4xl lg:text-6xl mb-6">
            {t.home.farmCtaTitle1}<br />
            <span className="text-farm-300 italic">{t.home.farmCtaTitle2}</span>
          </h2>
    ...
    <section className="py-24 lg:py-32 bg-earth-100">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="flex items-end justify-between mb-14 flex-wrap gap-4">
          <AnimatedSection>
            <span className="text-farm-500 text-xs uppercase tracking-[0.25em] font-bold mb-3 block">{t.home.menuLabel}</span>
            <h2 className="font-display font-black text-earth-900 text-4xl lg:text-5xl">
              {t.home.menuTitle1} <span className="text-farm-600 italic">{t.home.menuTitle2}</span>
            </h2>
          </AnimatedSection>
          <AnimatedSection direction="right">
            <Link href="/restaurant" className="inline-flex items-center gap-2 text-farm-600 hover:text-farm-500 font-bold text-sm uppercase tracking-wider group">
              {t.home.menuViewAll} <span className="group-hover:translate-x-1 transition-transform">→</span>
            </Link>
          </AnimatedSection>
        </div>
